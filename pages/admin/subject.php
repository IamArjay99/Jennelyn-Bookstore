            ...
            <div class="app" id="app">
                ...
                <article class="content dashboard-page">
                    <div class="title-block">
                        ...
                        <p class="title-description"> Subject: <?php echo $_GET['book_subject']; ?> </p>
                    </div>
                    <div class="row">
                            ...
                            <div class="card">
                                <div class="card-block">
                                    <div class="card-title-block">
                                        <h3 class="title"> <?php echo $_GET['book_subject']; ?> Books </h3>
                                    </div>
                                    <section class="section">
                                        <table class="table table-hover">
                                            ...
                                            <?php
                                                ...
                                                $book_subject = $_GET['book_subject'];
                                                $query = "SELECT * FROM book_info WHERE book_subject='$book_subject'";
