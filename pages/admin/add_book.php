            ...
            <div class="app" id="app">
                ...
                <article class="content dashboard-page">
                    <div class="title-block">
                        ...
                        <p class="title-description"> Add Book </p>
                    </div>
                            ...
                            <div class="row">
                                ...
                                <form role="form" method="POST" enctype="multipart/form-data">
                                    <div class="title-block">
                                        ...
                                        <input type="text" class="form-control underlined text-primary" name='update_title' required>
                                    </div>
                                    <div class="form-group">
                                        <label class="control-label"> Author </label>
                                        <input type="text" class="form-control underlined text-primary" name='update_author' required>
                                    </div>
                                    <div class="form-group">
                                        <label class="control-label"> Description </label>
                                        <textarea type="text" class="form-control underlined text-primary" name='update_description' rows='5' style='resize:none' required></textarea>
                                    </div>
                                    <div class="form-group">
                                        <label class="control-label"> Subject </label>
                                        <select class="form-control" name="update_subject" required>
                                            <option value="Computer" default>Computer</option>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control underlined text-primary" name='update_isbn' required>
                                    </div>
                                    <div class="form-group">
                                        <label class="control-label"> Copyright </label>
                                        <input type="text" class="form-control underlined text-primary" name='update_copyright' required>
                                    </div>
                                    <div class="form-group">
                                        <label class="control-label"> Publisher </label>
                                        <input type="text" class="form-control underlined text-primary" name='update_publisher' required>
                                    </div>
                                    <div class="form-group">
                                        <label class="control-label"> Cover </label><br>
                                        <input type="file" name="update_cover" required>
                                    </div>
                                    <div class="form-group">
                                        <label class="control-label"> Stocks </label>
                                        <input type="number" class="form-control underlined text-primary" name='update_stocks' required>
                                    </div>
                                    <div class="form-group">
                                        <label class="control-label"> Price </label>
                                        <input type="number" class="form-control underlined text-primary" name='update_price' required>
                                    </div>
                                    <div class="form-group">
                                        <input type="submit" name='add_submit' value="Submit" class="form-control btn btn-primary">
                                    </div>
                                </form>
                            </div>
                            </div>
