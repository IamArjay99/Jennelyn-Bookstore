<?php
    ...
    $sle = "SELECT * FROM admin WHERE first_name = '$session_user'";
    $sle_qry = mysqli_query($conn, $sle);
    $fetch = mysqli_fetch_array($sle_qry);
?>
                    ...
                    <section class="section">
                        <div class="row sameheight-container">
                            <div class="col-lg-12 col-md-12">
                                <h2>ADMIN PROFILE</h2><br><br>
                                <p><b>Firstname:</b><i style='color:#3fa0f9'> <?php echo $fetch['first_name'];?></i></p>
                                <p><b>Lastname:</b><i style='color:#3fa0f9'> <?php echo $fetch['last_name'];?></i></p>
                                <p><b>Age:</b><i style='color:#3fa0f9'> <?php echo $fetch['last_name'];?></i></p>
                                <p><b>Gender:</b><i style='color:#3fa0f9'> <?php echo $fetch['last_name'];?></i></p>
                                <p><b>Position:</b><i style='color:#3fa0f9'> <?php echo $fetch['last_name'];?></i></p>
                                <p><b>Username:</b><i style='color:#3fa0f9'> <?php echo $fetch['admin_username'];?></i></p>
                                <p><b>Phone: </b><i style='color:#3fa0f9'> <?php echo $fetch['phone_number'];?></i></p>
                                <p><b>Address:</b><i style='color:#3fa0f9'> <?php echo $fetch['last_name'];?></i></p>
                                <a class="btn btn-primary" style='border-radius:10px; background-color:#fe0fff; color:white'>Update</a>
                            </div>
                        </div>
                    </section>
                    <section class="section">
